...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "UpdatesArchiveBlock".
 */
export interface UpdatesArchiveBlock {
  introContent?: {
    root: {
      type: string;
      children: {
  ...
  id?: string | null;
  blockName?: string | null;
  blockType: 'updatesArchive';
}
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "EventsArchiveBlock".
 */
export interface EventsArchiveBlock {
  introContent?: {
    root: {
      type: string;
      children: {
...
export interface Event {
  ...
  title: string;
  /**
   * Optional image to represent this event
   */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "UpdatesArchiveBlock_select".
 */
export interface UpdatesArchiveBlockSelect<T extends boolean = true> {
  introContent?: T;
  limit?: T;
  id?: T;
  blockName?: T;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "ImageCarousel_select".
 */
export interface ImageCarouselSelect<T extends boolean = true> {
  slides?:
    | T
    | {
        media?: T;
