...
import { MerchandiseArchive } from '@/blocks/MerchandiseArchive/config'
          ...
          fields: [
            {
              name: 'layout',
              type: 'blocks',
              blocks: [CallToAction, Content, MediaBlock, Archive, UpdatesArchive, EventsArchive, MerchandiseArchive, FormBlock, ImageCarousel, Gallery, YouTube],
              required: true,
              admin: {
                initCollapsed: true,
              },
