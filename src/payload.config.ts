...
export default buildConfig({
  ...
  email: nodemailerAdapter({
    defaultFromAddress: process.env.SMTP_USER || 'abridgebetweenus@mail.egmrc.com',
    defaultFromName: 'A Bridge Between Us',
    transportOptions: {
  ...
  collections: [Pages, Posts, Updates, Events, Merchandise, Media, Categories, Users],
